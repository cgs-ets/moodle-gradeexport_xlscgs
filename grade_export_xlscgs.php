...
class grade_export_xlscgs extends grade_export {

    public $plugin = 'xlscgs';
    ...
    public function print_grades() {
        ...
        $myxls->write_string(0, $pos++, get_string('classcode', 'gradeexport_xlscgs'));
        ...
        $gui = new graded_users_iterator_xlscgs($this->course, $this->columns, $this->groupid);
        ...
        while ($userdata = $gui->next_user()) {
            ...
            $myxls->write_string($i, $j++, $user->groupname); // Groups.
